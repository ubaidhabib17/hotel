...
if (! function_exists('romawi')) {
    function romawi($angka){
        if ($angka=="01")  {$angka="I";}
        elseif ($angka=="02") {$angka="II";}
        elseif ($angka=="03") {$angka="III";}
        elseif ($angka=="04") {$angka="IV";}
        elseif ($angka=="05") {$angka="V";}
        elseif ($angka=="06") {$angka="VI";}
        elseif ($angka=="07") {$angka="VII";}
        elseif ($angka=="08") {$angka="VIII";}
        elseif ($angka=="09") {$angka="IX";}
        elseif ($angka=="10") {$angka="X";}
        elseif ($angka=="11") {$angka="XI";}
        elseif ($angka=="12") {$angka="XII";}
...
if (! function_exists('dateRange')) {
    function dateRange($start,$end){
        ...
        if ($xyear==$yyear) {
            //jika input tanggal berada di bulan yang sama
            if ($xmonth==$ymonth) {
                $nday =$ydate+1-$xdate;
            }else{
                $r2=NULL;

    ...
    <div class="properties-listing spacer">
        <div class="row">
            <div class="col-lg-3 col-sm-4">
                ...
                <div class="row">
                <div class="col-lg-12">
                    <select name="kelas_kamar_id" class="form-control">
                        <option value="">Pilih Kelas Kamar</option>
                        <?php
                        foreach($kelas_kamar->result_array() as $value){ ?>
                            <option value="<?php echo $value['id_kelas_kamar'];?>"><?php echo $value['nama_kelas_kamar'];?>
                            </option>
                         <?php   
                        }
                        ?>
                    ...
                    foreach($kamar->result_array() as $value){ ?>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="properties">
                                ...
                                <a class="btn btn-primary" href="<?php echo base_url();?>home/kamar_detail/<?php echo $value['id_kamar'];
                                    ?>">selengkapnya</a>
                            </div>
                        </div>
                        <!--properties-->
